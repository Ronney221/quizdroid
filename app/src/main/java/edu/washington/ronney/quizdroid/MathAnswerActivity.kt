...
class MathAnswerActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_math_answer)

        val answerText = findViewById<View>(R.id.answerGiven) as TextView
        val correctText = findViewById<View>(R.id.correctText) as TextView
        val runningTotal = findViewById<View>(R.id.runningTotal) as TextView
        ...
        button.setOnClickListener {
            ...
            if (questionCount == 2) {
                ...
                val intent = Intent(this, MathQuiz2Activity::class.java)
