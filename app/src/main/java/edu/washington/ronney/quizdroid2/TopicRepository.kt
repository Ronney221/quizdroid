...
interface TopicRepository  {
    ...
    companion object {
        val math = Topic("Math", "Math quiz", "This will be a quiz to test your MATH abilities",
                arrayOf(Quiz("What is 4 * 5?", "1", "5", "20", "hello", "20"),
        ...
        val physics = Topic("Physics", "Physics quiz", "This will be a quiz to test your Physics abilities",
                arrayOf(Quiz("WHICH LAW OF PHYSICS MAKES A PERPETUAL MOTION MACHINE IMPOSSIBLE?", "First law of thermodynamics", "Second law of thermodynamics", "Third law of thermodynamics", "First and second laws of thermodynamics", "First and second laws of thermodynamics"),
        ...
        val marvel = Topic("Marvel", "Marvel quiz", "This will be a quiz to test your Marvel abilities",
                arrayOf(Quiz("Which super hero can use and produce webs", "Super Man", "Spider Man", "Iron Man", "Captain American", "Spider Man"),
    ...
    data class Topic(val title : String, val shortDesc : String,val longDesc : String, val questions : Array<Quiz>) : Serializable
